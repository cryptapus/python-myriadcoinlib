...
class CoreMainParams(CoreChainParams):
    ...
    NAME = 'mainnet'
    GENESIS_BLOCK = CBlock.deserialize(x(''))
    SUBSIDY_HALVING_INTERVAL = 967680
    PROOF_OF_WORK_LIMIT = 2**256-1 >> 20

class CoreTestNetParams(CoreMainParams):
    NAME = 'testnet'
    GENESIS_BLOCK = CBlock.deserialize(x(''))
